        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-5xl lg:text-center flex flex-col justify-center items-center">
            ...
            <p className="mt-6 text-md text-gray-600 max-w-lg text-center">
              "IdeaSolution offers innovative and practical solutions tailored
              to your needs. Let's bring your ideas to life with expert guidance
            ...
            <dl className="grid mt-6 max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
              <div className="relative pl-16 ">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <span className=" inline-block ml-[60px]">
                    Customized Coverage Plans
                  </span>
                </dt>
                <dd className="mx-[60px] text-base leading-loose text-gray-600">
              ...
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-gray-900">
                  ...
                  <spam className="inline-block ml-[60px]">
              ...
              <div className="relative pl-16">
                <dt className="text-base font-semibold leading-loose text-gray-900">
                  <div className="absolute left-0 top-0 flex h-12 w-12 items-center justify-center rounded-lg bg-blue-700">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
